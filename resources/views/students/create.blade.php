    ...
    <div style="max-width: 640px; margin: 0 auto; animation: fadeInUp 0.5s ease-out;">
        <div class="card" style="padding: 2.5rem; border: 1px solid var(--border-light); box-shadow: 0 10px 25px -5px rgba(0,0,0,0.05);">
            <div style="text-align: center; margin-bottom: 2.5rem;">
                <div style="width: 64px; height: 64px; background: var(--bg); color: var(--primary); border-radius: 20px; display: flex; align-items: center; justify-content: center; margin: 0 auto 1rem;">
                    <i data-lucide="user-plus" style="width: 32px; height: 32px;"></i>
                </div>
                <h2 style="font-size: 1.25rem; font-weight: 800; color: var(--primary-dark);">Data Personal Siswa</h2>
                <p style="font-size: 0.8125rem; color: var(--text-muted); margin-top: 4px;">Pastikan NISN dan nama sesuai dengan data Dapodik.</p>
            </div>
            ...
            <form action="{{ route('students.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="input @error('name') is-invalid @enderror" placeholder="Masukkan nama lengkap siswa" value="{{ old('name') }}" required autofocus>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div class="form-group">
                        ...
                        <input type="text" name="nisn" class="input @error('nisn') is-invalid @enderror" placeholder="Contoh: 0012345678" value="{{ old('nisn') }}">
                ...
                <div style="margin-top: 2.5rem;">
                    <button type="submit" class="btn btn-primary" style="width: 100%; height: 52px; border-radius: 14px; font-weight: 800; font-size: 1rem;">
